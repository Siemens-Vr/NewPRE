...
const Sidebar = () => {
  const router = useRouter();
  const [openMenus, setOpenMenus] = useState({});
  const [isSidebarOpen, setIsSidebarOpen] = useState(false); // For toggling sidebar visibility on small screens
  ...
  return (
    <div className={`${styles.containers} ${isSidebarOpen ? styles.open : ""}`}>
