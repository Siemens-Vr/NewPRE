            ...
            <div className={styles.popup}>
                ...
                <form>
                    <div className={styles.inputGrid}>
                        ...
                        <div className={styles.inputGroup}>
                            ...
                            <div className={styles.doc}>
                                <div className={styles.docs}>
                                    ...
                                    {/*    name="procurement"*/}
                                    {/*    value={*/}
                                    {/*        formData.procurement instanceof File*/}
                                    {/*            ? formData.procurement.name*/}
                                    {/*            : formData.procurement*/}
                                    {/*                ? formData.procurement.split('/').pop()*/}
                                    {/*                : "N/A"*/}
                                    {/*    }*/}
                                    {/*    readOnly*/}
                        ...
                        {/* Claim, Imprest, Petty Cash specific fields */}
                        {renderFields()}
                    </div>

                    {/* Buttons outside the input grid */}
