...
//              <button onClick={() => setShowPopup(true)} className={styles.buttonUpdate}>Update Condition Details</button>
//             </div>
//           </>
//         ) : (
//           <p>Loading.....</p>
...
const EditComponent = () => {
  ...
  const [showPopup, setShowPopup] = useState(false);
  const [showConditionDetails, setShowConditionDetails] = useState(false); // New State
  const [component, setComponent] = useState(null);
